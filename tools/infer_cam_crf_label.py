...
parser.add_argument("--root_dir", default='/hy-tmp/VOC2012', type=str, help="root_dir")
parser.add_argument("--txt_dir", default='/hy-tmp/LOC_BE/datasets/voc', type=str, help="txt_dir")
parser.add_argument("--eval_set", default='val', type=str, help="eval_set")
parser.add_argument("--cam_path", default='/hy-tmp/LOC_BE/work_dir_voc/2023-05-12-16-21-44-589913/cams', type=str, help="logit")
